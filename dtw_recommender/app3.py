...
<style>
    ...
    * {
    ...
    /* Lampung-themed Background */
    .stApp {
        background: linear-gradient(135deg, #0a4d3c 0%, #1a7a5e 50%, #2d9b81 100%);
    ...
    .stApp::before {
        ...
        background-image: 
            ...
            url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80"><path d="M14 16H9v-2h5V9h2v5h5v2h-5v5h-2v-5zM40 40h-5v-2h5v-5h2v5h5v2h-5v5h-2v-5z" fill="rgba(255,255,255,0.03)"/></svg>');
        pointer-events: none;
        z-index: 0;
    }
    ...
    .info-card {
        background: linear-gradient(135deg, #1a7a5e 0%, #2d9b81 100%);
        padding: 2rem;
        border-radius: 16px;
        color: white;
        height: 100%;
        box-shadow: 0 10px 40px rgba(29, 122, 94, 0.4);
    ...
    .back-btn:hover {
        ...
        box-shadow: 0 8px 30px rgba(26, 122, 94, 0.4);
    }
